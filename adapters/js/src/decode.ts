...
// Node >= 18, Deno, Bun). br uses node:zlib, and without it is reported as
// unsupported and core calls the request unjudgeable. Output is capped at
...
type NodeZlib = { createBrotliDecompress(): NodeStream; createGunzip(): NodeStream };
