...
export const llmEndpoints: Rule = {
  ...
  text_fields: [
    ...
    "messages[*].content[*].input.**", "messages[*].content[*].toolUse.input.**", "messages[*].parts",
    "messages[*].parts[*].input.**", "messages[*].parts[*].output.**",
    "contents[*].parts", "contents[*].parts[*].functionCall.args.**", "contents[*].parts[*].function_call.args.**", "contents.parts", "chat_history[*].message", "message",
