...
=== TEST 17: a thin Worker's two legs (the /_jev/authz call, then the request it forwards) add a verdict's reputation points once; a lone forwarded leg adds them (g1-subject-id-evasion#5)
--- http_config eval: $::HttpConfig
